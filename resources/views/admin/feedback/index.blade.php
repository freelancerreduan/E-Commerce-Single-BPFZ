        ...
        <section class="section">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">List Images</h5>
                                    ...
                                    @forelse ($datas as $key => $data)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <img src="{{ asset($data->image) }}" alt="" style="width: 90px;" class="border rounded">
                                            </td>
                                            <td class="align-middle">
                                                <form action="{{ route('feedback.destroy', $data->id) }}" method="POST" class="text-nowrap">
                                                    @csrf
                                                    @method('DELETE')
                                                    {{-- <a href="{{ route('category.edit', $category->id) }}" class="btn btn-info btn-sm mx-1" target="_blank">Edit</a> --}}
