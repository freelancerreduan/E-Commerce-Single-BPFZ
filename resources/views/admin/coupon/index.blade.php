        ...
        <section class="section">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">List Coupon</h5>
                                    ...
                                    @forelse ($datas as $key => $data)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <b> {{ $data->coupon_name }}</b>
                                            </td>
                                            <td class="align-middle">{{ $data->discount }}%</td>
                                            <td class="align-middle">{{ Carbon\Carbon::parse($data->end_date)->format('Y-m-d') }}</td>
                                            <td class="align-middle">
                                                <form action="{{ route('coupon.destroy', $data->id) }}" method="POST" class="text-nowrap">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{ route('coupon.edit', $data->id) }}" class="btn btn-info btn-sm mx-1" target="_blank">Edit</a>
