                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="category" id="category" class="form-control" required onchange="setSubCategory(this)">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option {{ old('category') == $category->id ? 'selected' : '' }} value="{{ $category->id }}">{{ $category->category_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('category')
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" name="old_price" id="old_price"
                                                placeholder="Enter old price" class="form-control" value="{{ old('old_price') }}">
                                            @error('old_price')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="number" name="price" value="{{ old('price') }}" id="price" placeholder="Enter price"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="sku" id="sku" placeholder="Enter sku" value="{{ old('sku') }}"
                                                class="form-control" required>
                                            @error('sku')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="additional_info" id="additional_info" rows="5" class="form-control">{{ old('additional_info') }}</textarea>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" class="form-control" name="thumbnails" id="thumbnails" required>
                                    @error('thumbnails')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" class="form-control" name="featured_images[]"
                                        id="featured_images[]" required multiple>
...
@section('scripts')
    ...
    <script>
        var i = {{ old() ? count(old('varient'))-1 : 1 }};
